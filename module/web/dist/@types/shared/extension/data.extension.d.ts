export declare class Vector2 {
    ...
    static builder: (x?: number, y?: number) => import("./entity.extension").Builder<Vector2>;
}
export declare class Vector3 {
    ...
    static builder: (x?: number, y?: number, z?: number) => import("./entity.extension").Builder<Vector3>;
}
