...
import { ResourceScope, ResourceScopeAddons, ResourceScopeSetResourceActionProps, ResourceScopeState } from './resource.scope';
...
export declare class ResourceServiceImpl implements ResourceService {
    ...
    readonly resources: import("./resource.scope").Resources;
