...
import { Localization, LocalizationScope, LocalizationScopeAddLocalizationActionProps, LocalizationScopeAddons, LocalizationScopeState } from './localization.scope';
...
export declare class LocalizationServiceImpl implements LocalizationService {
    ...
    readonly localizations: import("./localization.scope").Localizations;
