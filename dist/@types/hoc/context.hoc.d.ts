...
export declare function ContextHoc<TContext>(Consumer: React.Consumer<TContext>): <P extends ContextHOCInjectedProps<TContext>, C extends React.ComponentType<P> = React.ComponentType<P>>(Component: C) => C;
