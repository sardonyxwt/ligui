...
export declare const styles: (...styles: (React.CSSProperties | [React.CSSProperties, boolean])[]) => any;
...
export declare const mergeRefs: <T>(...refs: any[]) => (ref: T) => void;
export declare class JSXServiceImpl implements JSXService {
    private _factories;
    classes: (...classes: (string | [string, boolean])[]) => string;
    styles: (...styles: any[]) => any;
    eventTrap: (evt: any, includeNative?: boolean) => void;
    isModifiedEvent: (evt: any) => boolean;
    mergeRefs: <T>(...refs: any[]) => (ref: T) => void;
