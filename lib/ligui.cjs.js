...
class InternationalizationServiceImpl {
    ...
    loadTranslateUnit(id) {
        ...
        const translateUnitData = (_a = translateUnitLoader.loader(id.key, id.locale)) !== null && _a !== void 0 ? _a : translateUnitLoader.loader(id.key, _store.state.defaultLocale);
